  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
          paddingTop: 'calc(var(--inset-top, 0px) + 1.25rem)',
          paddingBottom: 'var(--inset-bottom, 0px)',
        }}
        {...props}
      >
        {children}
        <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute right-5 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none" style={{ top: 'calc(var(--inset-top, 0px) + 1.25rem)' }}>
